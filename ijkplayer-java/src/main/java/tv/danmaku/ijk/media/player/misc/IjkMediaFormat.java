...
public class IjkMediaFormat implements IMediaFormat {
    ...
    //构造类，传入IjkMediaMeta.IjkStreamMeta类
    ...
    private static abstract class Formatter {
        //调用抽象方法得到媒体格式字符串，判断是否为空，不为空返回它，空返回"N/A"
    ...
    //内部静态实例HashMap<String, Formatter>类 sFormatterMap
    //存放 String -- Formatter 键值对
    private static final Map<String, Formatter> sFormatterMap = new HashMap<String, Formatter>();

    //构造代码，构造本类实例时默认执行，存储键值对
    {
